    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_roles_map", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_user_roles_map_roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_user_roles_map_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_role_user_UserId_RoleId",
                table: "role_user",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_roles_map_RoleId",
                table: "user_roles_map",
                column: "RoleId");
